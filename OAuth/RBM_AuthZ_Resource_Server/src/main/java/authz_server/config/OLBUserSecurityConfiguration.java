...
@Configuration
@EnableWebSecurity
public class OLBUserSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	*/
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers("/user/getEmployeesList","/user/getUserDetails").hasAnyRole("ADMIN").anyRequest().authenticated()
        .and()
    ...
    /*
     * Datasource for OLB user authentication 
    */
