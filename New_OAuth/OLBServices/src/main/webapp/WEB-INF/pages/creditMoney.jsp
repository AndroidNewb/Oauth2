...
<ul>
  ...
  <li><a class="active" href="http://localhost:9000/ui/creditmoney">Credit Money</a></li>
...
<ul>
  ...
  <li><a class="active" href="http://localhost:7777/ui/creditmoney">Credit Money</a></li>
